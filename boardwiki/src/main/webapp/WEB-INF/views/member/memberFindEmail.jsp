...
<section class="page-top-section set-bg"
	...
	<div class="page-info">
		...
		<div class="site-breadcrumb">
			<a href="/main/main">Home</a> / <span>Find ID</span>
		</div>
	</div>
</section>
<!-- Page top end-->
	...
	<div class="container">
		<div class="row">
			<div class="page-main">
				...
				<form:form action="memberFindEmail" id="member_findEmail"
					modelAttribute="memberVO">
					<ul>
						<li><form:label path="mem_name">이름</form:label> <form:input
								path="mem_name" /> <form:errors path="mem_name"
								cssClass="error-color" /></li>
						<li><form:label path="mem_phone">전화번호</form:label> <form:input
								path="mem_phone" /> <form:errors path="mem_phone"
								cssClass="error-color" /></li>
					</ul>
