...
<div class="page-main">
		...
		<div class="align-right">
			...
			<script type="text/javascript">
				$('#order').change(function(){
					location.href='teamBoardAdmin?keyfield='
			...
			<input type="button" value="글쓰기" 
			                    onclick="location.href='${pageContext.request.contextPath}/team/teamBoardWrite'">
		</div>                     
	</form>
	<c:if test="${count == 0}">
	...
	<table class="striped-table">
		...
		<tr>
			...
			<td class="align-left"><a href="teamBoardDetail?tea_num=${team.tea_num}"> ${team.tea_name}</a></td>
