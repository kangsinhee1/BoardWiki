            ...
            <div class="align-center"style="text-align: center;">
                <form action="list" id="rent_search_form" method="get">
                    ...
                    <ul class="search">
                        ...
                        <li>
                            <input type="search" name="keyword" id="keyword" class="form-control" value="${param.keyword}">
                        </li>
                        <li>
                    ...
                    <div class="align-right">
                        <select id="order" name="order" class="form-control">
                            ...
                            <option value="2" <c:if test="${param.order == 2}">selected</c:if>>대여기간</option>
                            <option value="3" <c:if test="${param.order == 3}">selected</c:if>>대출/반납</option>
                        </select>
                    </div>
                </form>
                </div>
